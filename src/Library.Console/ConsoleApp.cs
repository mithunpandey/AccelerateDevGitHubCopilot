...
public class ConsoleApp
{
    ...
    async Task<ConsoleState> SearchBooks()
    {
        ...
        Book? book = _jsonData.GetBookByTitle(bookTitle);
        ...
        //Loan? loan = _jsonData.Loans?.FirstOrDefault(l => l.BookItem!.BookId == book.Id && l.ReturnDate == null);
        Loan? loan = _jsonData.Loans?.FirstOrDefault(l => l.BookItem != null && l.BookItem.BookId == book.Id && l.ReturnDate == null);
